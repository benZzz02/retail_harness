    ...
    def _build_prompt(self, context: AgentContext) -> str:
        ...
        action_guidance = (
            ...
            "If the customer changes any part of the request while responding to "
                ...
                "For cheapest or most-expensive requests, enumerate every available "
                "variant in the tool observation and compute the true minimum or "
                "maximum price while preserving any stated constraints; do not pick "
